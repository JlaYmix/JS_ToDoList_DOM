...
function addText() {
    if(input.value === '') {
        ...
        /**
         *  Ця подія перекреслює текст коли галочка з'явилась, а коли вимкнена то тоді вимикає перекреслення
         */
...
/**
 * Отримання форми, щоб сторінка не оновлювалась кожного разу при додаванні тексту
 */
